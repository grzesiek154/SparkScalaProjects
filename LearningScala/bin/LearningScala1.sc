object LearningScala1 {
  ...
  val hello: String = "Siema!"                    //> hello  : String = Siema!
  println(hello)                                  //> Siema!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Siema!
  helloThere = hello + " There!"
  println(helloThere)                             //> Siema! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Siema!There!
  println(immutableHelloThere)                    //> Siema!There!
  val moreStuff = immutableHelloThere + "yeah";   //> moreStuff  : String = Siema!There!yeah
  ...
  println(f"Zero padding on the left: $numberOne%04d")
                                                  //> Zero padding on the left: 0001
  ...
  val piString: String = doublePi.toString();     //> piString  : String = 6.2831853
  println(piString + "000")                       //> 6.2831853000
