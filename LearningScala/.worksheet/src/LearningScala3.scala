object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def toUpperCaseFun(word: String) : String = {
  		word.toUpperCase();

  };System.out.println("""toUpperCaseFun: (word: String)String""");$skip(25); val res$3 = 
  toUpperCaseFun("test");System.out.println("""res3: String = """ + $show(res$3));$skip(88); 
  
  def toUpperCaseFun2(word: String, f: String => String) : String = {
  	f(word)
  };System.out.println("""toUpperCaseFun2: (word: String, f: String => String)String""");$skip(67); val res$4 = 
  
  toUpperCaseFun2("arrow function", word => word.toUpperCase());System.out.println("""res4: String = """ + $show(res$4))}
}
