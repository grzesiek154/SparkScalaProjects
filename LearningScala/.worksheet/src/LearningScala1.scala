object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(127); 
  ...
  val hello: String = "Siema!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  println(immutableHelloThere);$skip(48); 
  val moreStuff = immutableHelloThere + "yeah";System.out.println("""moreStuff  : String = """ + $show(moreStuff ));$skip(51); ;
  ...
  println(f"Zero padding on the left: $numberOne%04d");$skip(169); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(310); 
  ...
  val doublePi = 2 * pi;System.out.println("""doublePi  : Double = """ + $show(doublePi ));$skip(46); ;
  val piString: String = doublePi.toString();System.out.println("""piString  : String = """ + $show(piString ));$skip(28); ;
  println(piString + "000")}
